...
public class Report2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        l3.setText("Packets Sent to Worshop");

        l4.setText("Packets Received from Workshop");

        l5.setText("Packets Sold");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(l6, javax.swing.GroupLayout.DEFAULT_SIZE, 37, Short.MAX_VALUE)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(l7, javax.swing.GroupLayout.DEFAULT_SIZE, 37, Short.MAX_VALUE)
    ...
    private void b1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b1ActionPerformed
        // TODO add your handling code here:
        String month=txt1.getText();
        String year=txt2.getText();
        String query="select count(dtsend) as c from main where dtsend like '__/"+month+"/"+year+"'";
        DBManager d=new DBManager();
        String n=d.value(query);
        l6.setText(n);
        query="select count(dtrec) as c from main where dtrec='0'";
        n=d.value(query);
        l7.setText(n);
        query="select sum(quantity) as c from report where date like '__/"+month+"/"+year+"'";
        n=d.value(query);
        l8.setText(n);
